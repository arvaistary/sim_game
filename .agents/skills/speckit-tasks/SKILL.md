...
1. **Setup**: Run one platform-appropriate prerequisite command from repo root and parse FEATURE_DIR and AVAILABLE_DOCS list. All paths must be absolute:
   - Windows: `& powershell -NoProfile -ExecutionPolicy Bypass -File .specify/scripts/powershell/check-prerequisites.ps1 -Json`
   - POSIX: `.specify/scripts/bash/check-prerequisites.sh --json`
...
4. **[Story] label**: REQUIRED for user-story phase tasks when spec.md exists
...
1. **From User Stories (spec.md)** - PRIMARY ORGANIZATION when available:
   ...
   - Map all related components to their story:
    ...
    - In lite mode without spec.md, organize by plan workstream and mark dependencies between workstreams.
