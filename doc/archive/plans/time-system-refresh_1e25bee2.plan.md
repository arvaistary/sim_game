...
3. **Stabilize event identity and dedup**
...
4. **Reduce UI/store recomputation pressure**
...
5. **Normalize year/period representation**
...
6. **Test hardening and regression safety**
...
3. **Deterministic replay for bug reproduction**
...
4. **Strict period processing mode**
...
5. **Performance budget and safeguards**
...
6. **Save migration compatibility matrix**
...
4. **Offline progression (optional)**
