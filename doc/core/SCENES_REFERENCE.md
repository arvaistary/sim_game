...
| `HobbyScene.js` | `HobbyScene` | Хобби и увлечения; карточки действий категории `hobby` |
| `HealthScene.js` | `HealthScene` | Здоровье и фитнес; карточки действий категории `health` |
| `SelfdevScene.js` | `SelfdevScene` | Саморазвитие; карточки действий категории `selfdev` |
