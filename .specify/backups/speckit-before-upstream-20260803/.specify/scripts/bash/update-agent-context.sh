...
# Prefer the active work-item state when available so plan-derived updates stay
# aligned even on non-NNN branch names.
...
update_specific_agent() {
    ...
    case "$agent_type" in
        ...
        copilot)
            ...
            ;;
        cursor-agent)
            log_info "Cursor rules are managed manually via AGENTS.md — skipping automatic file generation"
            ;;
        qwen)
