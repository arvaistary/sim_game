...
**Доступные работы для старта** (из [`src/ecs/data/career-jobs.js`](src/ecs/data/career-jobs.js) или создать отдельный массив):
...
**Новые данные:**
- Стартовые работы (можно использовать из [`src/ecs/data/career-jobs.js`](src/ecs/data/career-jobs.js))
