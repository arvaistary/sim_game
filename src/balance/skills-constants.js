/**
 * Полная система навыков для Game Life
 * 4 категории: basic, professional, social, creative
 */
...
export const SOCIAL_SKILLS = [
  ...
  },
  {
    ...
    label: 'РЎР°РјРѕРґРёСЃС†РёРїР»РёРЅР° (СЂР°СЃС€.)',
    description: 'РЈСЃС‚РѕР№С‡РёРІРѕСЃС‚СЊ Рє СЂСѓС‚РёРЅРµ Рё СѓРјРµРЅРёРµ РґРµСЂР¶Р°С‚СЊ РєСѓСЂСЃ',
    category: 'social',
    color: 0x6D9DC5,
    maxLevel: 10,
    effects: {
    ...
    milestones: {
      10: { description: 'РђРІС‚РѕРјР°С‚РёС‡РµСЃРєРѕРµ РЅРµР±РѕР»СЊС€РѕРµ РІРѕСЃСЃС‚Р°РЅРѕРІР»РµРЅРёРµ РєР°Р¶РґСѓСЋ РЅРµРґРµР»СЋ' },
    },
  },
  {
    key: 'intuition',
...
export const SKILL_KEYS = ALL_SKILLS.map(s => s.key);
