...
export function createBaseSkillModifiers() {
  return {
...
export function recalculateSkillModifiers(skillLevels) {
...
export function clampSkillModifiers(modifiers) {
...
export function getSkillMilestones(skillKey, skillLevels) {
