...
export const EDUCATION_ACTIONS: BalanceAction[] = [
  {
    ...
    skillChanges: { basicCreativity: 2, discipline: 0.5 },
    actionType: 'education',
    effect: 'Голод +2.8, Энергия -4.2, Стресс -5.5, Настроение +7.5, Здоровье +0.5, Физическая форма -0.4, Креативность +2, Дисциплина +0.5',
  ...
  },
  {
    ...
    skillChanges: { specialization: 3, discipline: 1 },
    actionType: 'education',
    effect: 'Голод +4.2, Энергия -5.8, Стресс -6.5, Настроение +9.5, Здоровье -0.3, Физическая форма -0.7, Специализация +3, Дисциплина +1',
