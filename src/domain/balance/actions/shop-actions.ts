...
export const SHOP_ACTIONS: BalanceAction[] = [
  ...
  {
    id: 'shop_art_supplies',
    category: 'shop',
    title: 'Художественные материалы (краски, кисти, холст)',
    hourCost: 1,
    price: 2800,
    oneTime: true,
    grantsItem: 'art_supplies',
    actionType: 'shopping',
    effect: 'Открывает доступ к рисованию и живописи как хобби',
    mood: '🎨 Материалы для творчества — начало пути художника',
    ageGroup: AgeGroup.TODDLER,
  },
  {
    id: 'shop_camera',
    ...
    grantsItem: 'camera',
    actionType: 'shopping',
    effect: 'Открывает доступ к фотографии',
    mood: '📸 Фотоаппарат — ловить моменты',
    ageGroup: AgeGroup.TEEN,
  },
  {
    id: 'shop_garden_tools',
    category: 'shop',
    title: 'Садоводческий инвентарь',
    hourCost: 1,
    price: 3500,
    oneTime: true,
    grantsItem: 'garden_tools',
    actionType: 'shopping',
    effect: 'Открывает доступ к садоводству',
    mood: '🌱 Инвентарь для работы с растениями',
    ageGroup: AgeGroup.TODDLER,
  },
  {
    id: 'shop_cooking_set',
    category: 'shop',
    title: 'Набор посуды и кухонных принадлежностей',
    hourCost: 1,
    price: 5500,
    oneTime: true,
    grantsItem: 'cooking_set',
    actionType: 'shopping',
    effect: 'Открывает доступ к кулинарным экспериментам',
    mood: '🍳 Всё для готовки — на кухне должно быть удобно',
    ageGroup: AgeGroup.CHILD,
  },
  {
    id: 'shop_meditation_cushion',
    category: 'shop',
    title: 'Медитационная подушка и принадлежности',
    hourCost: 0.5,
    price: 2200,
    oneTime: true,
    grantsItem: 'meditation_cushion',
    actionType: 'shopping',
    effect: 'Удобное место для медитации',
    mood: '🧘 Всё для комфортной практики',
    ageGroup: AgeGroup.CHILD,
  },
]