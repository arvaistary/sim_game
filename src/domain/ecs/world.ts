 ...
 * TypeScript версия
 */
import type { ComponentDataMap, ComponentKey, Entity, ECSSystem } from './types'
...
const CANONICAL_TO_LEGACY_KEY: Record<string, string> = {
...
export class ECSWorld {
   ...
   */
  getSystem<T extends ECSSystem>(SystemClass: new (...args: unknown[]) => T): T | null {
