...
export interface ECSSystem {
  init?(world: import('../world').ECSWorld): void
  update?(world: import('../world').ECSWorld, deltaTime: number): void
}
...
export interface ECSWorldInterface {
  ...
  getSystem<T extends ECSSystem>(name: string): T | undefined
