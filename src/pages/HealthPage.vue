<template>
  <GameLayout title="Здоровье">
    <div class="action-page">
      <RoundedPanel>
        <h3 class="page-section-title">Здоровье</h3>
        <p class="page-section-subtitle">Забота о физическом и ментальном здоровье</p>
      </RoundedPanel>
...
const actions = getActionsByCategory('health')
