...
const tabs = [
  { id: 'programs', icon: 'book', title: 'Программы', shortDesc: 'Курсы и программы обучения' },
  { id: 'study', icon: 'medal', title: 'Учёба и навыки', shortDesc: 'Формальное обучение и развитие профессиональных навыков' },
  { id: 'practice', icon: 'bolt', title: 'Практика и привычки', shortDesc: 'Лёгкие действия для регулярного саморазвития' },
] as const
